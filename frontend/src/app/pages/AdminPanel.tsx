...
export default function AdminPanel() {
  ...
  useEffect(() => {
    const fetchDashboard = async () => {
      ...
      try {
        ...
        const mappedPending = data.pendingLawyers.map((lawyer: any) => ({
          id: lawyer.id,
  ...
  const handleApprove = async (lawyerId: string, name: string) => {
    try {
  ...
  const handleReject = (lawyerId: string, name: string) => {
